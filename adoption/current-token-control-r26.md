...
This candidate still needs independent control review and lawful workflow integration. The existing sealed workflow/descendant contract and the Phase 17 publication-base conflict remain unresolved. Its checks are not disabled, repinned, or silently treated as successful here. No workflow, historical artifact, ruling, runtime gate or scheduler is changed by this candidate. The project-spec change is the proposed Conjugal declaration described above.
