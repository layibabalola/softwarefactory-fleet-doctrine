...
atomic receipts must account for every selected test exactly once, with no skips,
...
tests. A 720-second deadline leaves room within the unchanged 15-minute CI job;
