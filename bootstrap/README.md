...
6. REPORT, pasting raw output lines exactly as printed (never restructure them): T; each step-2 rung and its result; D and how it was found or cloned; the fetch result; the source and line 1 of what you read. Then follow PROMPT A for project T, with D as <doctrine>. If PROMPT A §1 stops, stop, and read nothing further from D. A §1 recovery into `<D>-origin` is not a stop.
