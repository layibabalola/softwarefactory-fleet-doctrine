...
- [`specs/fleet-universal-provider-control-reconciliation.md`](specs/fleet-universal-provider-control-reconciliation.md)
  — zero-authority R22 candidate atop exact frozen R21, retaining every later canonical project
  disposition. R22 binds the quota-ledger and quota-locks child-directory identities, publishes a
  ...
  `CERTIFIED_PROCESS_CHOKE_POINT_NOT_INSTALLED`. R22 preserves that honest zero-authority boundary.
